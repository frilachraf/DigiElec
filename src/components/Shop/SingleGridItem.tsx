  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-white shadow-1 min-h-[270px] mb-4">
        {/* <Image src={item.imgs.previews[0]} alt=""/> */}
        <img src={item.imgs.previews[0]} alt=""  width={250} height={250} style={{ width: "auto", height: "auto" }} />
      ...
      <span className="flex items-center gap-2 font-medium text-lg">
        ...
        {/* <span dangerouslySetInnerHTML={{ __html: item.price_html }}></span> */}
      </span>
    </div>
  );
};
